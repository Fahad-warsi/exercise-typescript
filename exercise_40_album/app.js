...
function make_album(title, name) {
    var album = {
        artistName: name,
        albumTitle: title,
    };
    return "Title :  ".concat(album.albumTitle, ", Artist : ").concat(album.artistName);
}
var album1 = make_album("Meri Kahani", "Atif Aslam");
var album2 = make_album("Jal Pari", "Atif Aslam");
var album3 = make_album("Teri Yad", "Sajjad Ali");
console.log(album1);
console.log(album2);
console.log(album3);
//Make at least one new function call that includes the number of tracks on an album.
var album = function (tracks, title, name) {
    var album = {
        artistName: name,
        albumTitle: title,
        NoOftracks: tracks,
    };
    return "No. of tracks : ".concat(tracks, ", Title :  ").concat(album.albumTitle, ", Artist : ").concat(album.artistName);
};
var album4 = album(4, "Hawa Hawa", "Hasan Jahangir");
console.log(album4);
